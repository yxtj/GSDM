...
std::pair<std::vector<MotifBuilder>, size_t> StrategyOFG::sortUpNewLayer(std::vector<MotifBuilder>& layer)
{
	if(flagNetworkPrune)
...
std::pair<std::vector<MotifBuilder>, size_t> StrategyOFG::removeDuplicate(std::vector<MotifBuilder>& layer)
{
